...
export const HERO1 = (
  <img key="hero 1" alt="hero 1" height={1770} src={hero1} width={1808} />
);
...
export const MAP = (
  <img key="map" alt="map" height={615} src={map} width={3000} />
);

export const SQUARE1500 = (
  <img
    key="square-1500"
    alt="square-1500"
    height={1500}
